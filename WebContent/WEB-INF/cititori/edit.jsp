			...
			<div class="container-fluid">
				...
				<div class="card mb-4">
					<div class="card-body">
						...
						<form:form
							action="${pageContext.request.contextPath}/cititori/save.htm"
							method="post" commandName="cititoriForm">
							...
							<div class="form-group">
								...
								<form:input class="form-control py-4" path="prenume"
									type="text" id="nume" />
							</div>
							<div class="form-group">
								<label class="small mb-1" for="nume">Adresa</label>
								<form:input class="form-control py-4" path="adresa"
									type="text" id="nume" />
							</div>
							<div class="form-group">
								<label class="small mb-1" for="nume">Localitate</label>
								<form:input class="form-control py-4" path="localitate"
									type="text" id="nume" />
							</div>
							<div class="form-group">
								<label class="small mb-1" for="nume">Judet</label>
								<form:input class="form-control py-4" path="judet" 
									type="text" id="nume" />
							</div>
							<div class="form-group">
								<label class="small mb-1" for="telefon">Telefon</label>
								<form:input class="form-control py-4" path="telefon" 
					...
					<div class="card-footer text-center">
						<div class="small">
							<a href="<c:url value="/cititori/lista.htm"/>">&lt; Back to
								list</a>
						</div>
					</div>
				</div>
